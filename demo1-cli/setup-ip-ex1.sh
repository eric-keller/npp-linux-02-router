...
# Ping from lan1 to lan3 shouldn't work - despite all routing tables being setup
# because the lan* routing table entries are assuming they are directly connected
# (so it will ARP for the destination address)
# lan1 ping 10.0.3.2
